...
func (h *AuthHandler) handleRegister(w http.ResponseWriter, r *http.Request) {
	...
	h.log.Info().
		Str("raw_username", req.Username).
		Str("raw_email", req.Email).
		Str("raw_password", req.Password).
		Msg("debug register payload")
	...
	user, err := h.store.CreateUser(ctx, req.Username, req.Email, passwordHash)
	if err != nil {
...
func (h *AuthHandler) handleLogin(w http.ResponseWriter, r *http.Request) {
	...
	user, exist, err := h.store.GetUserByUsername(ctx, req.Username)
	if err != nil {
